...
const WhyShoseCusraComponent = () => {
  const reviews = [
    {
      name: "فاطمة أحمد",
      message: "والله منتج رائع! استعملته لمدة أسبوعين والنتيجة مذهلة 😍 بشرتي صارت ناعمة ونضرة",
      time: "14:32",
      avatar: "👩🏻",
      rating: 5
    },
    {
      name: "محمد علي",
      message: "جربت منتجات كثيرة بس كورا فعلاً مختلف! النتائج سريعة وواضحة ✨",
      time: "15:45",
      avatar: "👨🏻",
      rating: 5
    },
    {
      name: "سارة محمود",
      message: "أنصح كل البنات يجربوه! منتج طبيعي 100% وآمن تماماً 💚 ما له أي آثار جانبية",
      time: "16:20",
      avatar: "👩🏽",
      rating: 5
    },
    {
      name: "أحمد حسن",
      message: "خدمة العملاء ممتازة والتوصيل سريع! المنتج وصل في نفس اليوم 🚚⚡",
      time: "17:10",
      avatar: "👨🏽",
      rating: 5
    }
      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            اكتشف تجارب حقيقية من عملائنا الراضين
          </p>
        </motion.div>
        ...
        <div className="grid lg:grid-cols-3 gap-8 items-start">
          ...
          >
            {[
              ...
              { icon: "🚚", value: "24h", label: "توصيل سريع", color: "from-green-400 to-emerald-500" },
              { icon: "💚", value: "100%", label: "طبيعي", color: "from-emerald-400 to-green-500" }
            ].map((stat, index) => (
              <motion.div 
                key={index}
